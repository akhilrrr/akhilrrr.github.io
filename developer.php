...
<?php 
  $titletag = "Developer Profile • A-R.XYZ";
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
          ...
          <img src="https://media.giphy.com/media/SJi9FbqXnwK0U/giphy.gif" class="img-fluid" alt="Developer profile" style="margin-bottom: 20px;
    width: 200px; border-radius: 5px;">
            <h4 style="font-size: 20px; text-align: center; font-family: Pop-B;">Exciting updates in progress, stay tuned!</h4>
          </div>
      </div>
    </div>
  </div>
