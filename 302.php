    ...
    <div class="row">
      <div class="col-md-12">
          <div class="side-head" style="text-align: center;">
            <img src="https://media.giphy.com/media/LPn77YyDIqfhm/giphy-downsized.gif" class="img-fluid" alt="Grindin" style="margin-bottom: 20px;
    width: 200px; border-radius: 5px;">
            <h4 style="font-size: 20px; text-align: center; font-family: Pop-B;">My bad, but the file you're tryna download ain't up for grabs right now</h4>
          </div>
      </div>
    </div>
  </div>
