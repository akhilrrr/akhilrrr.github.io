  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="side-head" style="text-align: center;">
          <img src="https://media.giphy.com/media/vVEjKbAUFtZzFzjYbz/giphy.gif" class="img-fluid" alt="Developer profile" style="margin-bottom: 20px;
    width: 200px; border-radius: 5px;">
            <h4 style="font-size: 20px; text-align: center; font-family: Pop-B;">We took a wrong turn! Let's bounce back to where we started.</h4>
          </div>
      </div>
